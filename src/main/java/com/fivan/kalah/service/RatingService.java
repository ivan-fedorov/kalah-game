...
public class RatingService {
   ...
   */
  public RatingCalculation updateRating(
      Integer playerOneId, Integer playerTwoId, GameStatus status) {
    ...
    RatingCalculation calculation =
        ratingCalculator.calculate(playerOne.getRating(), playerTwo.getRating(), status);
